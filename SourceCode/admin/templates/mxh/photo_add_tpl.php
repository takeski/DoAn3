...
<form name="supplier" id="validate" class="form" action="index.php?com=mxh&act=save_photo<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <div class="formRow">
			...
			<div class="formRight">
                <input type="text" name="tenhinh" title="Nhập tên hình ảnh" id="name" class="tipS validate[required]" value="" />
			</div>
			<div class="clear"></div>
		</div>		                     
        ...
        <label>Link</label>
        <div class="formRight">
                <input type="text" name="link<?=$i?>" title="Nhập link" id="name" class="tipS validate[required]" value="" />
			</div>
            <div class="clear"></div>
        </div>
		<div class="formRow">
