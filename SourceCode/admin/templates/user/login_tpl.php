...
<div class="loginWrapper">
    ...
    <div class="widget" id="loginForm">
        <div class="title"><img src="<?=CUR_PATH?>/images/icons/dark/files.png" alt="" class="titleIcon" /><h6>Đăng nhập</h6></div>
        <form action="/admin?com=user&act=login" id="validate" class="form" method="post">
            <fieldset>
                <div class="formRow">
                ...
                <div class="ajaxloader"><img src="<?=CUR_PATH?>/images/loader.gif" alt="loader" /></div>
                <div id="loginError">
                </div>
            </fieldset>
        </form>
    ...
    <div class="widget" id="forgotForm" style="display:none;">
        <div class="title"><img src="<?=CUR_PATH?>/images/icons/dark/files.png" alt="" class="titleIcon" /><h6>Khôi phục mật khẩu</h6></div>
