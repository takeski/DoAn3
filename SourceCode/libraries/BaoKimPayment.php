...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '29404';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = '106d85b522b45009'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	 ...
	 */
	public function verifyResponseUrl($data = array())
	{
